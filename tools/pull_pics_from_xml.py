...
def main(directory):
    ...
    output_file_path = os.path.join(directory, output_file)  # Full path for the output file
    output_lines = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process XML files in a directory and save output to a text file.")
    parser.add_argument('--dir', required=True, help="Directory containing the XML files")
