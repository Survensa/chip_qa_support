...
def run_command(commands, testcase):
    ...
    save_path = os.path.join(os.path.expanduser('~'), "chip_qa_support", "logs", "execution_logs")
    ...
    output_directory = os.path.join(os.path.expanduser('~'), "chip_qa_support", "logs", "validation_logs")
    ...
    if build_confirmation in ['y', 'yes']:
        ...
        if clusters_confirmation in ['y', 'yes']:
            for cluster_name in selected_clusters:
                file = "Cadmin.txt"
                file_path = os.path.join(os.path.expanduser('~'), "chip_qa_support", "commands", file)
